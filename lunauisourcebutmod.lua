...
function Luna:CreateWindow(WindowSettings)
	...
	function Window:CreateHomeTab(HomeTabSettings)
		...
		HomeTabPage.detailsholder.dashboard.Client.Title.Text = (isStudio and "Debugging (Studio)" or identifyexecutor()) or "Your Executor Supports identifyexecutor."
		for i,v in pairs(HomeTabSettings.SupportedExecutors) do
			...
			if v == identifyexecutor() then
				...
				HomeTabPage.detailsholder.dashboard.Client.Subtitle.Text = "Your Executor Is Supported By This Script."
				break
			end
		end
