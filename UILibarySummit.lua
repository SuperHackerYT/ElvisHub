...
function summitLib:CreateWindow(ConfigArgs)
	...
	ConfigArgs.Name = ConfigArgs.Name or "Unnamed Elvis UI Menu"
	...
	TemporaryText.Text = `<b>{ConfigArgs.Name}</b> ; <b> Universal Script Hub </b>`
	...
	function window:CreateNotification(args)
		...
		args.Description = args.Description or "Elvis"
	...
	window:CreateNotification({Title = "Elvis Hub Universal",Description = "Interface Successfully loaded.", Duration = 3})
	return window
end
