...
do
    ...
    WindUI:Notify(
        {
            Title = gradient("ELVIS HUB", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
    ...
    local Window =
        WindUI:CreateWindow(
        {
            Title = gradient("ELVISHUB - Murder Mystery 2", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Icon = "rbxassetid://82795327169782",
    ...
    local function teleportToPlayer()
        if (teleportTarget and teleportTarget.Character) then
            ...
            WindUI:Notify(
                {Title = "ELVISHUB", Content = "Target not found or unavailable", Icon = "x-circle", Duration = 3}
            )
        end
    end
...
Tabs.MainTab:Button({
    ...
    local AutoInject = {
        Enabled = false,
        ScriptURL = "https://raw.githubusercontent.com/SuperHackerYT/ElvisHub/refs/heads/main/ElvisHubMM2.lua"
    }
    Tabs.SettingsTab:Toggle(
        {
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("ELVISHUB .GG/ELVISHUB", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            Desc = "My Main Social",
            Image = "star",
            Color = "Red",
            Buttons = {
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("Elvis Gaming - YouTube", Color3.fromHex("#ff0000"), Color3.fromHex("#000000")),
            ...
            Buttons = {
                {
                    ...
                    Icon = "circle",
                    Callback = function()
                        if pcall(setclipboard, "https://youtube.com/@elvisgamingroblox") then
                            WindUI:Notify(
                                {
                                    Title = "Copied!",
                                    Content = "Link copied to clipboard.",
    ...
    ELVISHUB â¢ MM2 commands:

    |â¢ Silent Aimbot

    |â¢ All Sheriff Functions

    |â¢ Better shot

    |â¢ Fixed errors

    |â¢ Shot variants [default; teleport]

    |â¢ Faster shots

    |â¢ New shot button

    |â¢ Shot button settings

    |â¢All Murder Functions

    |â¢ Fixed kill player

    |â¢ Kill all function

    |â¢ All Innocent Functions

    |â¢ Grab GunDrop

    |â¢ Auto Grab Gun Drop

    |â¢ Grab gun and shoot murder function

    |â¢ Fixed Notifications

    |â¢ Fixed Check GunDrop Function

    |â¢ Autofarm Money

    |â¢ Autofarm variables [Tp; smooth; walk]

    |â¢ Coin checker function

    |â¢ Autofarm settings

    |â¢ Tp to lobby function
    ...
    â¢ Autofarm rare eggs

    â¢ Fix bugs

    â¢ New esp functions [tracers; names; highlights and more!]

    â¢ Grab Gun Variables [Tp to gun; Gun tp to you]
